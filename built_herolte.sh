#!/bin/bash
# Kernel Built script for FirePower v0.0.1 

export MODEL=herolte
export ARCH=arm64
export BUILD_CROSS_COMPILE=/home/benjaminw8/android/android-ndk-r12/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin/aarch64-linux-android-

export BUILD_JOB_NUMBER=`grep processor /proc/cpuinfo|wc -l`

RDIR=/Home/android/kernel
...
if [ $MODEL = herolte ]
then
	KERNEL_DEFCONFIG=FirePower_herolte_defconfig
else [ $MODEL = hero2lte ]
	KERNEL_DEFCONFIG=FirePower_hero2lte_defconfig
fi
